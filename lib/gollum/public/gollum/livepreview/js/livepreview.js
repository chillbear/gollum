...
var makePreviewHtml = function () {
  ...
  // clean up ```python, ```bash --> ```, which aren't handled well right now
  text = text.replace(/```(.+)/g, '```')
...
var applyTimeout = function () {
  ...
  */
  ...
  editorSession.addEventListener('changeScrollTop', syncPreview);
  editorSession.addEventListener('changeCursor', function() {
